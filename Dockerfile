...
CMD ["sh", "-c", "cp -f /data/channels.json /app/channels.json 2>/dev/null || true; nginx -g 'daemon off;' & python tvmanager_final.py & python app_final.py & python yt_relay.py & wait"]
